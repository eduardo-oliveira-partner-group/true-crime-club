...
- Keep cards physical and restrained: dossier surfaces, subtle asymmetry, warm shadows, tabs, pins, tape, dashed separators, and micro-rotation only when they serve the page. Avoid applying rotations, pin highlights, and folder tabs systematically on standard content pages or layout list components (such as FAQ accordions); keep those interfaces flat and clean, reserving tactile visual accents for places where they serve a direct storytelling or narrative purpose.

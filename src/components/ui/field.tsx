...
const fieldVariants = cva(
  'group/field flex w-full data-[invalid=true]:text-destructive',
  {
    variants: {
      orientation: {
        // gap-0: formInputClass already provides mt-2 between label and control
        vertical: 'flex-col gap-0 *:w-full [&>.sr-only]:w-auto',
        horizontal:
        ...
        responsive:
          'flex-col gap-0 *:w-full @md/field-group:flex-row @md/field-group:items-center @md/field-group:gap-3 @md/field-group:*:w-auto @md/field-group:has-[>[data-slot=field-content]]:items-start @md/field-group:*:data-[slot=field-label]:flex-auto [&>.sr-only]:w-auto @md/field-group:has-[>[data-slot=field-content]]:[&>[role=checkbox],[role=radio]]:mt-px',
      },
    },
    defaultVariants: {

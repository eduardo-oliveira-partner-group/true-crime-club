...
export const mockProducts: Product[] = [
  {
    ...
    shortDescription: "Edição limitada de março com itens colecionáveis e materiais exclusivos.",
    type: "box",
    price: 18990,
    subscriberPrice: 14990,
    images: ["boxes/caixa-03.jpg"],
  ...
  },
  {
    ...
    shortDescription: "Primeira caixa avulsa da coleção, ideal para começar o caso.",
    type: "box",
    price: 18990,
    subscriberPrice: 15990,
    images: ["boxes/caixa-01.jpeg"],
    categories: ["box", "avulsa"],
    inStock: true,
    availability: "available",
    featured: true,
...
export const mockPlans: SubscriptionPlan[] = [
  {
    ...
    slug: "mensal",
    name: "Plano Mensal",
    description: "Cobrança mensal com flexibilidade para cancelar quando quiser.",
...
export const mockOrders: Order[] = [
  ...
  },
  {
    ...
    invoicePlaceholder: "NF-e TCC-202602-0018 — download disponível na área do cliente.",
  },
]
...
export const mockClues: Clue[] = [
  {
    ...
    description: "Gravação transcrita de um telefonema recebido na madrugada de 14 de janeiro.",
    cycleNumber: 1,
    status: "liberado",
  ...
  },
  {
    ...
    description: "Imagem recuperada de uma câmera descartável encontrada no local.",
    cycleNumber: 2,
    status: "liberado",
  ...
  },
  {
    ...
    description: "Extrato parcial com movimentações suspeitas na véspera do incidente.",
    cycleNumber: 3,
    status: "liberado",
...
export const mockExclusiveContent: ExclusiveContent[] = mockClues.map((clue) => ({
  id: clue.id,
  slug: clue.slug,
  title: clue.title,
...
export const mockDynamicContent: DynamicContentBlock[] = [
  ...
  },
  {
    key: "faq.intro",
    type: "text",
    value: "Respostas para as dúvidas mais comuns sobre o clube, planos e entregas.",
    route: "/faq",
  },
]
...
export const mockSeoEntries: Record<string, SeoEntry> = {
  ...
  "/loja": {
    ...
    description: "Explore boxes atuais, edições avulsas e produtos complementares do clube.",
  },
  "/assinatura": {
    title: "Planos de assinatura",
    description: "Compare planos mensal e anual e entenda o ciclo de cobrança e entrega.",
  },
  "/faq": {
    title: "Perguntas frequentes",
    description: "Tire dúvidas sobre planos, entrega, pagamento e cancelamento.",
  },
}

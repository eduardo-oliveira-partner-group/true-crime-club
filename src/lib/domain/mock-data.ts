...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    description:
      'Terceira caixa avulsa da coleção True Crime Club. Produto disponível em estoque limitado.',
  ...
  },
  {
    ...
    description:
      'Quarta caixa avulsa da coleção True Crime Club. Produto disponível para compra avulsa.',

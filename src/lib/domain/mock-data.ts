...
export const mockProducts: Product[] = [
  {
    ...
    name: 'Box 01 — Primeira Página',
    description:
      'Primeira caixa arquivada do Caso Victória Monteiro. Reúne documentos, objetos e pistas que abrem a investigação — ideal para quem quer começar avulso.',
    shortDescription: 'BOX 01 do Caso Victória Monteiro — Primeira Página.',
    type: 'box',
    price: 14990,
    subscriberPrice: 12990,
    images: ['design-sugerido/box-01.png'],
    categories: ['box', 'avulsa', 'arquivada'],
    inStock: true,
    ...
    cycleNumber: 1,
    includedItems: [
      'Caixa arquivada do Caso Victória Monteiro',
      'Edição avulsa — Primeira Página',
  ...
  {
    id: 'prod-002',
    slug: 'tcc-caixa-02-avulsa',
    name: 'Box 02 — Tudo ao Meu Alcance',
    description:
      'Segunda caixa arquivada do Caso Victória Monteiro. Aprofunda a linha investigativa com novas evidências e itens físicos para montar a próxima teoria.',
    shortDescription: 'BOX 02 do Caso Victória Monteiro — Tudo ao Meu Alcance.',
    type: 'box',
    price: 14990,
    subscriberPrice: 12990,
    images: ['design-sugerido/box-02.png'],
    categories: ['box', 'avulsa', 'arquivada'],
    inStock: true,
    availability: 'available',
    featured: true,
    ...
    includedItems: [
      'Caixa arquivada do Caso Victória Monteiro',
      'Edição avulsa — Tudo ao Meu Alcance',
      'Compra sem assinatura',
    ],
  ...
  },
  {
    ...
    name: 'Box 03 — Pena',
    description:
      'Terceira caixa arquivada do Caso Victória Monteiro. Peças-chave da trama em uma edição avulsa para quem quer retomar ou completar o arquivo.',
    shortDescription: 'BOX 03 do Caso Victória Monteiro — Pena.',
    type: 'box',
    price: 14990,
    subscriberPrice: 12990,
    images: ['design-sugerido/box-03.png'],
    categories: ['box', 'avulsa', 'arquivada'],
    inStock: true,
    availability: 'available',
    featured: true,
    ...
    relatedProductIds: ['prod-002', 'prod-006'],
  },
  {
    id: 'prod-006',
    slug: 'tcc-caixa-04-avulsa',
    name: 'Box 04 — Estão de Olho em Você',
    description:
      'Quarta caixa arquivada do Caso Victória Monteiro. Documentos e objetos que elevam a tensão da investigação — disponível avulsa quando quiser.',
    shortDescription:
      'BOX 04 do Caso Victória Monteiro — Estão de Olho em Você.',
    type: 'box',
    price: 14990,
    subscriberPrice: 12990,
    images: ['design-sugerido/box-04.png'],
    categories: ['box', 'avulsa', 'arquivada'],
    inStock: true,
    availability: 'available',
    featured: true,
    ...
    includedItems: [
      'Caixa arquivada do Caso Victória Monteiro',
      'Edição avulsa — Estão de Olho em Você',
      'Compra sem assinatura',
    ],
...
export const mockFilesByBox: Record<
  string,
...
a parte que pega de verdade eu tranquei.

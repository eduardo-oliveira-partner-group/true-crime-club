      ...
      <div className={styles.heroInner}>
        <div className={styles.heroCopy}>
          ...
          <h1>
            ...
            Doze caixas.
            <br />
            <span>Um ano de investigação.</span>
          </h1>
  ...
  return (
    <section id="oque" className={styles.introSection}>
      <div className={styles.introGrid}>
        ...
        <div>
          <p>
            O TrueCrime Club é um clube de assinatura que transforma o melhor do
            gênero numa experiência física. Cada caso é uma história longa,
    ...
    <section className={styles.section}>
      ...
      <div className={styles.boxGrid}>
        {boxItems.map((item) => {
          ...
          return (
            <article key={item.code} className={styles.featureCard}>
      ...
      <div className={styles.stepsCard}>
        {steps.map((step) => (
          <article key={step.number} className={styles.stepItem}>
            <div style={{ color: step.color }}>{step.number}</div>
            <h3>{step.title}</h3>
    ...
    <section className={styles.section}>
      ...
      <div className={styles.testimonialGrid}>
        {testimonials.map((testimonial) => (
          <article key={testimonial.user} className={styles.testimonialCard}>
  ...
  return (
    <section id="avulsas" className={styles.section}>
      ...
      <div className={styles.archiveHint}>
        <span />
        <a href="#arquivos">ver edições anteriores nos arquivos →</a>
      </div>
    </section>
  )
}
      ...
      <div className={styles.archiveInner}>
        ...
        <div className={styles.archiveGrid}>
          {archiveBoxes.map((box) => (
            <ArchiveCard key={box.box} box={box} />
          ))}
        </div>
...
function ArchiveCard({
  ...
  return (
    <article className={styles.archiveCardWrap}>
      <div className={styles.archiveCardBack} />
      <div className={styles.archiveTab}>Caso Victória Monteiro</div>

...
export async function generateMetadata({
  ...
  if (!product) {
    return buildMetadata({
      path: `/design-sugerido/loja/${slug}`,
      noindex: true,
    })
  }
  ...
  return buildMetadata({
    path: `/design-sugerido/loja/${slug}`,
    title: `${product.name} — Loja (Design Anterior)`,
    noindex: true,
  })
}
...
export default async function ProductDetailPage({
  ...
  const breadcrumbItems = [
    { name: 'Home', path: '/design-sugerido' },
    { name: 'Loja', path: '/design-sugerido/loja' },
    { name: product.name, path: `/design-sugerido/loja/${product.slug}` },
  ]

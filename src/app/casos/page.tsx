...
export default function CasosPage() {
  ...
  return (
    <div className="terminal-crt-container flex min-h-screen w-full flex-col justify-between p-4 font-mono text-sm/relaxed text-[#62d84e] md:p-6">
      {/* ---------------- WELCOME STAGE ---------------- */}
      {stage === 'welcome' && (
          ...
          <div className="terminal-crt-border-glow border border-[#62d84e]/40 bg-[#070f08]/95 p-6 md:p-8">
            ...
            <div className="mb-6 border border-[#62d84e]/30 bg-[#09140b]/40 p-4">
              <div className="mb-2 flex items-center justify-between text-xs">
                ...
                <span className="font-bold text-[#62d84e]">{cipherShift}</span>
              </div>
              <input
                type="range"
                min="0"
        ...
        <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col justify-between">
          ...
          <div className="mb-4 flex flex-col gap-4 border border-[#62d84e]/30 bg-[#09110b]/90 p-4 text-xs md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex items-center gap-6">
              <span className="font-mono text-[#62d84e]/60">
                SOMENTE LEITURA
              </span>
              <span className="font-mono text-[#ff8c00]">{timeStr}</span>
              <div className="flex items-center gap-3">
                <Link
                  href="/cliente/perfil"
                  className="border border-[#62d84e]/30 px-3 py-1 font-mono transition hover:border-[#62d84e] hover:bg-[#62d84e]/10"
                >
                  [ PAINEL ]
                </Link>
                <button
                  onClick={handleLogout}
                  className="border border-[#d84132]/40 px-3 py-1 font-mono text-[#ffb0a5] transition hover:border-[#d84132] hover:bg-[#d84132]/10"
                >
                  [ SAIR ]
                </button>
              </div>
          ...
          <div className="grid min-h-[440px] flex-1 grid-cols-1 border border-[#62d84e]/30 bg-[#050b06]/70 md:grid-cols-[240px_1fr]">
            ...
            <aside className="overflow-y-auto border-r border-[#62d84e]/30 bg-[#070e08]/90 p-3">
              ...
              {currentFiles.length === 0 ? (
                ...
                <div className="space-y-4">
                  <div className="border border-[#62d84e]/20 bg-[#050b06]/80 text-xs">
                    {/* Table Header */}
                    <div className="grid grid-cols-[1fr_160px_100px] gap-2 border-b border-[#62d84e]/20 p-2.5 text-[10px] font-bold tracking-wider text-[#62d84e]/50 uppercase">
                      <span>Nome</span>
                      ...
                      {currentFiles.map((file) => {
                        ...
                        return (
                          <div
                            ...
                            className={`grid cursor-pointer grid-cols-[1fr_160px_100px] items-center gap-2 p-2.5 transition ${
                              isFileLocked
                          ...
                          >
                            ...
                            <span className="font-mono text-[11px] text-[#62d84e]/50">
                              {file.modified}
                            </span>
                            <span className="font-mono text-[11px] text-[#62d84e]/50">
                              {file.size}
          ...
          {/* Bottom explorer bar */}
          <div className="mt-4 flex items-center justify-between border border-t-0 border-[#62d84e]/30 bg-[#09110b]/90 p-3 text-xs">
            {currentPath.length > 0 ? (
              <button
                onClick={goBack}
                className="flex cursor-pointer items-center gap-2 border border-[#62d84e]/50 px-4 py-1.5 font-mono text-[#62d84e] uppercase transition-all hover:bg-[#62d84e]/10"
              >
                <IconArrowLeft className="size-4" />[ VOLTAR ]
              </button>
            ) : (
              <span className="text-[#62d84e]/40 select-none">
                [ SISTEMA PRONTO ]
              </span>
            )}
            <span className="font-mono text-[10px] text-[#62d84e]/50">
      ...
      {lockedFileToUnlock && (
        <div className="animate-fade-in fixed inset-0 z-50 flex items-center justify-center bg-[#020502]/90 p-4">
      ...
      {selectedFile && (
        <div
          ...
          className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto bg-[#020502]/92 p-4 cursor-pointer"
        >
          <div
            onClick={(e) => e.stopPropagation()}
            className="win flex max-h-[90vh] w-full max-w-3xl flex-col justify-between border border-[#62d84e] bg-[#050b06] shadow-[0_0_30px_rgba(98,216,78,0.2)] cursor-default"
          >
            {/* Header bar */}
                ...
                <div className="space-y-5">
                  ...
                  !recoveredAudios[selectedFile.id] ? (
                    ...
                    <div className="space-y-4">
                      ...
                      <audio
                        ref={(el) => {
                          ...
                          if (el) {
                            ...
                            el.ontimeupdate = () => setAudioCurrentTime(el.currentTime)
                      ...
                      <div className="border border-[#62d84e]/30 bg-black p-5 rounded flex flex-col md:flex-row items-center gap-6 justify-between">
                        {/* Play/Pause Button on the Left */}
                        <div className="flex items-center gap-4 shrink-0">
                          <button
                            onClick={() => handleTogglePlay(selectedFile.id)}
                            className="size-14 rounded-full border-2 border-[#62d84e] bg-[#62d84e]/10 hover:bg-[#62d84e]/20 flex items-center justify-center text-[#62d84e] cursor-pointer transition-all shadow-[0_0_10px_rgba(98,216,78,0.2)] focus:outline-none"
                            aria-label={isPlayingAudio ? 'Pausar' : 'Tocar'}
                          >
                            {isPlayingAudio ? (
                              <span className="text-xl tracking-tighter font-bold">█ █</span>
                            ) : (
                          ...
                          <div className="font-mono text-xs flex flex-col">
                            <span className="text-[#62d84e] font-bold text-sm tracking-wider">
                              {isPlayingAudio ? 'REPRODUZINDO' : 'PAUSADO'}
                            </span>
                            <span className="text-[#62d84e]/60 text-[11px] mt-0.5">
                              {formatTime(audioCurrentTime)} / {formatTime(audioDuration || 6)}
                            </span>
                          </div>
                        </div>

                        {/* Waveform Visualizer */}
                        <div className="flex-1 w-full h-14 flex items-center justify-center gap-1.5 px-4 bg-[#050b06] border border-[#62d84e]/10 rounded">
                          {[35, 60, 45, 90, 75, 40, 20, 80, 50, 95, 35, 70, 85, 45, 60, 25, 55, 90, 40, 75, 20, 80, 65, 30].map((h, idx) => {
                            const animClass = isPlayingAudio ? 'animate-pulse' : ''
                            const heightFactor = isPlayingAudio ? Math.sin(audioCurrentTime * 10 + idx) * 15 + h : h
                            const heightPct = Math.min(100, Math.max(10, heightFactor))
            ...
            {/* Modal Footer */}
            <div className="flex shrink-0 items-center justify-between border-t border-[#62d84e]/30 bg-[#070e08]/90 p-3 text-xs">
              {selectedFile.downloadUrl ? (
                <a
                  href={selectedFile.downloadUrl}
                  download
                  className="flex cursor-pointer items-center gap-2 border border-[#62d84e]/40 px-4 py-1.5 font-mono tracking-wider text-[#62d84e] uppercase transition-all hover:border-[#62d84e] hover:bg-[#62d84e]/10"
                >
              ...
              <button
                ...
                className="cursor-pointer border border-[#62d84e] bg-[#62d84e]/10 px-5 py-1.5 font-mono font-bold tracking-wider text-[#62d84e] uppercase transition hover:bg-[#62d84e]/25"
              >
                [ Fechar Visualizador ]
              </button>
            </div>
      ...
      {selectedFile && selectedFile.type === 'image' && isImageZoomed && (
        <div
          ...
          className="fixed inset-0 z-60 overflow-y-auto p-4 md:p-8 cursor-zoom-out flex flex-col items-center bg-[#020502]/98"
        >
          <div className="absolute top-4 right-4 rounded border border-[#62d84e] bg-[#09110b] px-4 py-1.5 font-mono text-xs font-bold tracking-wider text-[#62d84e] uppercase select-none z-10">
            [ FECHAR ZOOM ]
          </div>
          <div className="w-full max-w-[95vw] md:max-w-[85vw] lg:max-w-[75vw] my-auto py-12 flex flex-col items-center">
            <img
              src={selectedFile.downloadUrl}
              alt={selectedFile.name}
              className="w-full h-auto object-contain border border-[#62d84e]/30 shadow-[0_0_40px_rgba(98,216,78,0.3)] bg-black"
              onClick={(e) => e.stopPropagation()}
            />
            <div
              onClick={(e) => e.stopPropagation()}
              className="mt-6 max-w-xl rounded border border-[#62d84e]/30 bg-[#09110b]/90 px-4 py-2 text-center font-mono text-[11px] leading-relaxed text-[#62d84e] cursor-default"
            >
              {selectedFile.content}
            </div>
          </div>
